...
namespace UtilityLibrary.Unity.Runtime
{
    ...
    {
        /// <summary>
        /// Constructor that initializes the SharedArray with a managed array.
        /// </summary>
        /// <param name="managed">The managed array to initialize the SharedArray with.</param>
        public SharedArray(T[] managed) { Initialize(managed); }

        /// <summary>
        /// Constructor that initializes the SharedArray with a specified size.
        /// </summary>
        /// <param name="size">The size of the SharedArray.</param>
